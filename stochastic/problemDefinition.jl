...
function create_optimization_model()
  ...
  maintenances=read_maintenances("/home/kwidz/Doctorat/ProjetMaintenanceTurbines/Projet Jesus/ModelSelection/data/sched_12.txt")
      ...
      for t in 2:size(periods)[1]
        ...
        for m in 1:size(maintenances)[1]
          if JuMP.value(start_maintenance[m,t])==1 && maintenances[m].power_house_index==i
            print(";Starting maintenance ", m, " durée :",maintenances[m].duration)
          end
        end
        println()
